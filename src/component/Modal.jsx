...
import sistem_produksi from '../assets/sistem-produksi.mp4';
  ...
  return (
    <>  
          <div
            className={`justify-center items-end flex w-full  overflow-x-hidden overflow-y-auto absolute bottom-[${pixelBottom}px]  inset-0 z-50 outline-none focus:outline-none`}
          >
